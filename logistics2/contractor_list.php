...
//pull out all user form database
  ...
  $all_vendors = find_all_approval_contractor();
  ?>
      ...
      <div class="card-body">
        ...
        <?php foreach($all_vendors as $a_vendor): ?>
          <tr>
           ...
           <td><?php echo remove_junk(ucwords($a_vendor['contractor_status']))?></td>
           <td> 
           ...
           <td class="text-center">
             <div class="btn-group">
                <a href="contractor_approval1.php?id=<?php echo (int)$a_vendor['id'];?>" class="btn btn-sm btn-success" style="margin-right: 5px;"><i class="bi bi-pencil"></i>
