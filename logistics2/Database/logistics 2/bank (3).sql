...
(20220006, 'miguel', 'luna', 'bucao', 'miguelbucao@gmail.com', 'dd4bee80840a7929dcf0a1670199b26581b9f24b', '09194562814', '1998-02-14', 24, 'Male', 'Single', 'catholic', 'brgy concepcion gulayan Malabon City', '2022-04-30 13:57:42', ''),
...
(20220036, 'jiraiyah', 'sanin', 'golib', 'jiraiyah623@gmail.com', '5ed5d228da1d00d947818b658c3e97fb5b4d5786', '09123846012', '2000-02-07', 22, 'Male', 'Single', 'catholic', 'caloocan city', '2022-05-01 23:20:58', ''),
(20220037, 'Paul', 'B', 'Din', 'pauldin0416@gmail.com', '6e0ea0f575a458fe5a3502c2a8532731e8564569', '09991760132', '2000-04-16', 22, 'Male', 'Single', 'Catholic', 'Mulawinan Valenzuela', '2022-05-03 23:17:51', '');
...
(1000124, 'fafa', 'fafa', 'faf', 'HR DEPARTMENT', 'Payatas A Quezon, city', ' lilgabs08@gmail.com', 9098374504, '', 'RIDER', 'fafafa', '2022-05-12 14:18:31'),
(1000125, 'fafa', 'af', 'fa', 'fa', 'f', ' fafaffafaffafafaf@gmail.con', 9098374504, 'faf', 'RIDER', 'fsfsfsfs', '2022-05-15 08:55:08'),
(1000126, 'faf', 'bbi', 'bibi', 'HR DEPARTMENT', 'gggagagag', 'ikesepria12@gmail.c', 9098374504, 'male', 'RIDERddd', '', '2022-05-14 18:18:46'),
(1000127, 'fafa', 'affa', 'faf', 'faf', 'faf', ' fafaffafaffafafaf@gmail.con', 9098374504, 'faf', 'faf', 'fsfsfsfs', '2022-05-15 09:38:03'),
(1000128, 'fafa', 'affa', 'faf', 'af', 'afaf', ' fdafag@gmail.com', 4, 'faf', 'RIDER', 'fafafaf', '2022-05-15 09:48:22');
...
(4, '15', 'Add new Applicant Lester', 'uploads/BANKING-AND-FINANCE-LOGISTICS-II.pdf', '', 'Vendor', '2022-04-14 18:36:01'),
...
(26, 30330046, 'julius', 'HR4_admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 1, 'no_image.jpg', 1, '2022-05-05 16:43:39', 'HR4', 'HR4 Manager'),
...
(1, 'Visits by nonemployees', 'State such visits are not allowed unless authorized by the company.', '2022-04-23 05:46:45'),
(5, 'Authorization procedures', 'How does a visitor obtain authorization? Who within the company has the power to authorize visitors?', '2022-04-23 06:57:07'),
(6, 'Off-limit areas', ' Identify any areas that are off limits to all visitors (e.g., confidential records, equipment, computer network).', '2022-04-23 07:00:31'),
(7, 'Identification of visitors', 'Must visitors sign in and out? Must they present a photo identification? What type of photo identification? Must visitors wear identification badges or passes? Must they be escorted by a supervisor or company official?', '2022-04-23 07:00:48'),
(8, 'Heightened requirements.', 'Are there times when you need to increase restrictions (e.g., after hours, while key operations or processes are in progress, during holidays and weekends, after terrorist alerts)?', '2022-04-23 07:01:11'),
(9, 'Visits by employees during nonworking hours', 'Some companies restrict regular employees’ access to the plant or office during off-hours. What procedures should be followed by an employee who has a legitimate reason to visit the premises after work hours?', '2022-04-23 07:06:50'),
(10, 'Visits by employees on leave', 'Employees who are on leave may also stop by. Address how these individuals should be treated. For example, can the proud parent on a parental leave bring the newborn to the office for co-workers to see? What access is permitted for employees who are ', '2022-04-23 07:07:12'),
(11, 'Former employees', 'How are former employees treated? Are they treated just like nonemployees?', '2022-04-23 07:07:44'),
(12, 'Vendors, suppliers, and contractors. ', 'Are vendors and others required to sign-in? Is there a color-coded badge? Are they escorted everywhere? Is their access limited?', '2022-04-23 07:08:10'),
(13, 'Temporary employees', 'Are temporary employees treated like regular employees or like contractors?', '2022-04-23 07:08:29'),
(14, 'Visits by friends and family members. ', 'Some employers consider friends and family members “outsiders” and restrict their visits accordingly; others feel that with the supervisor’s authorization, family members in particular should be allowed to visit on occasion to see where the employee ', '2022-04-23 07:09:18'),
(15, 'Recording devices', ' May visitors bring into your building recording devices, such as cameras, camera phones, etc.?', '2022-04-23 07:32:35'),
(18, 'Supervisors’ responsibilities.', 'Should supervisors challenge unescorted strangers who aren’t wearing the proper identification? Should they direct or escort unauthorized visitors to the front office or out of the building? Should they contact Security or escort someone in Human Res', '2022-04-23 08:23:37');
...
(1000135, 'fafgag', 'gagag', 'gagag', 'gagag', 'gaga', ' lilgabs08@gmail.com', 9098374504, 'fafaf', 'RIDER', 'fafa', '2022-05-15 10:44:16');
...
--
-- Constraints for table `manpower_request`
--
ALTER TABLE `manpower_request`
  ADD CONSTRAINT `FK_quali` FOREIGN KEY (`qualification_id`) REFERENCES `job_qualifications` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `resigned`
--
ALTER TABLE `resigned`
  ADD CONSTRAINT `FK_resign` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tblleaves`
--
ALTER TABLE `tblleaves`
  ADD CONSTRAINT `FK_leave` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `FK_empl` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
