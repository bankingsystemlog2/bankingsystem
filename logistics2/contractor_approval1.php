<?php
  $page_title = 'Contractor Approval';
...
<?php
 ...
 if(isset($_POST['update-contractor'])) {
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
          <form method="post" action="contractor_approval1.php" class="clearfix">
          <div class="form-group">
            ...
            <div class="form-group">
              <label for="contractor_status">Status</label>
                <select class="form-control" name="contractor_status">
                  <option <?php if($vendors['contractor_status'] === 'Approved') echo 'selected="selected"';?>value="Approved">Approved</option>
                  <option <?php if($vendors['contractor_status'] === 'Rejected') echo 'selected="selected"';?>value="Rejected">Rejected</option>
                  <option <?php if($vendors['contractor_status'] === 'Pending') echo 'selected="selected"';?>value="Pending">Pending</option>
                </select>
            </div>
            <div>
              <br>
              <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal">Update</button>
            <a href="contractor_list.php" name="update-contractor" class="btn btn-danger">Cancel</a>
       ...
       <button type="submit" name="update-contractor" class="btn btn-success ">Update</button></a>
