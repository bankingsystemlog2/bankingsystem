<?php
  $page_title = 'Contract Already Signed';
...
<nav class="breadcrumbs">
  ...
  <a href="#checkout" class="breadcrumbs__item is-active">Contract Already Signed</a>
</nav>
<!-- /Breadcrumb -->
  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        <span class="badge rounded-pill bg-success"><i class="bi bi-list"></i> Contract Already Signed</span>
      </div>
      </div>
      <div class="card-body">
        <div class="table-responsive">
          <table
            ...
            style="width: 100%" >
            <?php
            $query = "SELECT * FROM contract c, users u WHERE u.employee_id=c.con_eid AND c.con_status='Signed' ORDER BY con_id ASC";
