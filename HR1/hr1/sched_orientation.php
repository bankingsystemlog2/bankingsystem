...
$sql = "INSERT INTO orientation (employee_id,date,time,location) VALUE ('$id','$date','$time','$location');";
if($db->query($sql)){
...
if($db->query($sql)){
    ...
    $_SESSION['status'] ="Orientation date scheduled and an email was sent to notify the employee";
