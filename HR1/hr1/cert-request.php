...
$sql = "SELECT social_recognition.*,employees.* FROM social_recognition JOIN employees ON ";
$sql .= "social_recognition.employee_id = employees.employee_id WHERE status = 'for approval'";
$result = $db->query($sql);
