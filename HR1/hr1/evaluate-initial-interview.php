...
$sql = "SELECT applicants.first_name,applications.status,applicants.last_name,initial_interview.* FROM applicants";
  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        <span class="badge rounded-pill bg-success"><i class="bi bi-table"></i>Evaluation of initial interview</span>
