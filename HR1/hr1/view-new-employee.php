...
<nav class="breadcrumbs">
    ...
    <a href="newhire-onboard.php" class="breadcrumbs__item">Back</a>
      ...
      <div class="row">
        ...
        <div class="col-md-6" style="margin-bottom: 7vh;">
         ...
         <div class="col-md-12">
          ...
          <input type="checkbox"  name="cont_signing" onclick="return false"
          <?php 
if($applicant['status'] == 'for orientation' OR $applicant['status'] == 'ongoing orientation' OR  $applicant['status'] == 'for training' OR  $applicant['status'] == 'ongoing training' OR $applicant['status'] == 'for deployment' OR $applicant['status'] == 'ongoing deployment'){
   ...
   <div class="col-md-12" style="margin-top: 5vh;">
    <?php if($applicant['status'] == 'for contract signing'){ ?>
    <a href="contract_sched.php?id=<?php echo $applicant['employee_id']; ?>" class="btn btn-sm btn-success">
      <i class="bi bi-calendar"></i>Schedule Contract Signing</a>

   <?php } ?>
    <?php if($applicant['status'] == 'for orientation'){ ?>
    <a href="sched_orientation.php?id=<?php echo $applicant['employee_id']; ?>" class="btn btn-sm btn-success"><i class="bi bi-calendar">Schedule Orientation</a>

   <?php } ?>
   <?php if($applicant['status'] == 'for training'){ ?>
    <a href="sched_training.php?id=<?php echo $applicant['employee_id']; ?>" class="btn btn-sm btn-success"><i class="bi bi-calendar">Schedule Training</a>
