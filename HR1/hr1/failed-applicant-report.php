...
<html>
<head>
	<title>Failed applicants report</title>
...
<?php
$sql = "SELECT final_interview.*, applicants.*,applications.* FROM final_interview JOIN applicants ON";
$sql .= " final_interview.applicant_id = applicants.applicant_id JOIN applications ON final_interview.";
...
?>
  ...
  <div class="col-md-12">
    <div class="">
      ...
      <table class="table table-bordered table-striped">
        ...
        <?php if($row>0){ do{ 
          ...
          <tr>
           ...
           <td class="text-center"><?php echo remove_junk(ucwords($a_jobs['final_average']))?></td>
     ...
     <a href="failed-applicants-final.php" id="a" class="btn btn-danger">BACK</a>
     </div>
    </div>
  </div>
