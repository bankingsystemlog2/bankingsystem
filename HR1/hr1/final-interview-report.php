...
$sql = "SELECT final_interview.*, applicants.* FROM final_interview JOIN applicants ON";
$sql .= " final_interview.applicant_id = applicants.applicant_id";
$result = $db->query($sql);
...
<html>
<head>
  <title>Final Interview Schedules Report</title>
    ...
    <div class="">
      <div class="panel-heading clearfix">
        ...
        <strong>
          ...
          <span>Final Interview Report Report</span>
       </strong>
     </div>
     <div class="col-md-6">
     ...
     <a href="final-interview.php" id="a" class="btn btn-danger">BACK</a>
     </div>
    </div>
  </div>
</div>
