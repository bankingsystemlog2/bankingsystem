...
$sql = "SELECT employees.*, contract_signing.* FROM employees JOIN contract_signing ON employees.employee_id = contract_signing.employee_id";
$result = $db->query($sql);
    ...
    <div class="">
      <div class="panel-heading clearfix">
        ...
        <strong>
          ...
          <span>Employees on Contract Signing</span>
       </strong>
     </div>
     <div class="col-md-6">
     ...
     <a href="contract_signing.php" id="a" class="btn btn-danger">BACK</a>
