...
$sql = "SELECT performance_review.*,employees.* FROM performance_review JOIN employees ON";
$sql .= " performance_review.employee_id = employees.employee_id WHERE status = 'for approval'";
$result = $db->query($sql);
