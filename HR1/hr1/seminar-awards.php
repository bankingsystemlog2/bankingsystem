...
<nav class="breadcrumbs">
  ...
  <?php elseif ($user['user_level'] === '6'): ?>
   <a href="home.php" class="breadcrumbs__item">Home</a>
  <?php endif; ?>
  <a href="#checkout" class="breadcrumbs__item is-active">List Of Pending Seminar Certificates</a>
</nav>
...
<div class="row" style="margin-bottom:10%; max-height: 600px;">
       ...
       <table
        ...
        <?php do{ ?>
          <tr>
           ...
           <td class="text-center"><?php echo remove_junk(ucwords($info['seminar_title']))?></td>
  ...
  <a href="print-learning.php?id=<?php echo $stat['employee_id'] ?>&award=<?php echo $stat['award'] ?>&date=<?php echo $stat['date'] ?>" class="btn btn-sm btn-success"  title="print certificate">Print Certificate</a>
...
if($stat['status'] == 'printed'){
          ...
          <?php } ?>
            ...
            <?php }else { ?>
                <a href="request-learning-certifiate.php?id=<?php echo $info['employee_id'];?>" class=" btn btn-sm btn-success"  title="">
