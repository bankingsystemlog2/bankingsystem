...
<nav class="breadcrumbs">
  ...
  <?php endif; ?>
  <a href="#checkout" class="breadcrumbs__item is-active"> Past Evaluation List</a>
</nav>
  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
         <div class="text-end">
          <a href="evaluation-report.php" class="btn btn-info btn-sm pull-right"><i class="bi bi-printer-fill"></i> Print Report</a>
         </div>
      </div>
           ...
           <td class="text-center" width="15%">
             <div class="btn-group">
                <a href="view-past-pr.php?id=<?php echo $info['employee_id'];?>" class="btn btn-sm btn-info"  title="view">
                 ...
                 <div class="btn-group">
                <a href="remove-past-evaluation.php?id=<?php echo $info['employee_id'];?>" class="btn btn-sm btn-danger"  title="removes">
                  <span>Remove</span>
               </a>
                </div>
