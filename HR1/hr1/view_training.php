...
<nav class="breadcrumbs">
    <a href="training.php" class="breadcrumbs__item">Home</a>
  <a href="#" class="breadcrumbs__item is-active">List of Users</a>
</nav>
...
<div class="row" style="margin-bottom:10%; max-height: 600px;">
  ...
  <div class="col-md-12">
        ...
        <div class="col-md-6" style="margin-bottom: 7vh;">
         ...
         <div class="col-md-12">
          ...
          <input type="checkbox" name="orientation" onclick="return false"<?php 
            ...
            if($applicant['status'] == 'for training' OR $applicant['status'] == 'for deployment' OR $applicant['status'] == 'ongoing training' OR $applicant['status'] == 'requesting for deployment approval'){
              echo 'checked';
            }
          ?>>
        </div>
         <div class="col-md-12">
          ...
          <input type="checkbox" name="training"onclick="return false" <?php
           ...
           if($applicant['status'] == 'for deployment' OR $applicant['status'] == 'requesting for deployment approval'){
              echo 'checked';
           }
            ?>>
        </div>
   ...
   <div class="col-md-12" style="margin-top: 5vh;">
   <?php if($applicant['status'] == 'ongoing training'){ ?>

    <a href="proceed_to_deployment.php?id=<?php echo $applicant['employee_id']; ?>" class="btn btn-sm btn-success" >Proceed to deployment</a>

  <?php }

    if($applicant['status'] == 'for deployment'){ ?>

    <a href="request_deployment.php?id=<?php echo $applicant['employee_id']; ?>" class="btn btn-sm btn-success" >Request Deployment</a>
