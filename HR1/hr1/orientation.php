...
$sql = "SELECT orientation.*, employees.* ,new_hires.* FROM employees JOIN new_hires ON employees.employee_id = new_hires.employee_id";
$sql .= " JOIN orientation ON employees.employee_id = orientation.employee_id";
$result = $db->query($sql);
