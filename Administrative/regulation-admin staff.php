...
<nav class="breadcrumbs">
  ...
  <?php endif; ?>
  <a href="#" class="breadcrumbs__item is-active">Rules and Regulations</a>
</nav>
<!-- /Breadcrumb -->
...
<nav class="breadcrumbs">
  ...
  <?php endif; ?>
		...
		<a href="VisitorPolicy-admin staff.php"><button type="button" class="btn btn-light">Visitor Policy</button></a> 
      ...
      <div class="modal-body">
       <form method="post" action="rulesandregulation.php">
          <div class="form-group">
				...
				<input type="number_format" class="form-control" name="visitor-ra_no" placeholder="Ra no." required>
				</div>
