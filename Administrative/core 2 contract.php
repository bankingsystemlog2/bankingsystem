<?php
  ...
  // Checkin What level user has permission to view this page
   page_require_level(2);
    $all_core2files = find_all('core1files')
?>
<?php
// Checkin What level user has permission to view this page
 page_require_level(1);
 $groups = find_all('core1files');
 $users_id = current_user()['id'];
// $result = find_vendor_by_id('audit',$users_id);
 $is_show = 1;
 $all_vendors = find_all('core1files');
?>
<?php
...
<nav class="breadcrumbs">
  ...
  <?php elseif ($user['user_level'] === '2'): ?>
   <a href="user_dashboard.php" class="breadcrumbs__item">Home</a>
  <?php endif; ?>
    <a href="requestcontract.php"><button type="button" class="btn btn-primary">BACK</button></a> 
  <a href="facilityavailable.php"><button type="button" class="btn btn-light">HR 1</button></a> 
<a href="facilityapprove.php"><button type="button" class="btn btn-light">HR 2</button></a>
<a href="facility-pending-request.php"><button type="button" class="btn btn-lights">HR 3</button></a>
<a href="facility-complain.php"><button type="button" class="btn btn-light">H4</button></a>
 <a href="facilityavailable.php"><button type="button" class="btn btn-light">CORE 1</button></a> 
<a href="core 2 contract.php"><button type="button" class="btn btn-light">CORE 2</button></a>
<a href="facility-pending-request.php"><button type="button" class="btn btn-lights">LOGISTIC 1</button></a>
<a href="facility-complain.php"><button type="button" class="btn btn-light">LOGISTIC 2</button></a>
<a href="facility-complain.php"><button type="button" class="btn btn-light">FINANCIAL</button></a>
</nav>
...
<div class="panel-body">
      ...
      <head>
        ...
        <body>
        <div class="tab">
            <button class="tablinks" onclick="Tab(event, 'ApplicationForm')">Add Contracts </button>
        ...
        <div id="ApplicationForm" class="tabcontent">
            <form method="post" action="core 2 contract.php" autocomplete="off" enctype="multipart/form-data"> 
