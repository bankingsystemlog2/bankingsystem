   ...
   if(empty($errors)){
	 ...
	 $sql .= " VALUES ('{$vis_fname}','{$vis_mname}','{$vis_lname}','{$vis_contact_no}','{$vis_company_department}',' {$vis_reason}')";
      ...
      if($db->query($sql)){
        ...
        redirect('visitorblacklisted.php',false);
      } else {
...
<nav class="breadcrumbs">
  ...
  <?php endif; ?>
  <a href="visitorinformation.php" class="breadcrumbs__item is-active">List of blacklist person</a>
</nav>
<!-- /Breadcrumb ------------------------------------------------------------------------------------------------>
  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
		...
		<div class="text-end">
          <a href="register_visitor.php" class="btn btn-primary pull-right" data-bs-toggle="modal" data-bs-target="#exampleModal"> ADD</a>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form method="post" action="visitorblacklisted.php">
