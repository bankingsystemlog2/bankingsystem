        ...
        <div class="table-responsive">
          ...
          <td><?php echo remove_junk(ucfirst($policy['id'])); ?></td>
                    ...
                    <td class="text-center">
                      <div class="btn-group">
                      <a href="edit_visitor.php?id=<?php echo $policy['id'];?>" class="btn btn-sm btn-success" style="margin-right: 5px;"><i class="bi bi-pencil"></i></a>      
                      <a href="delete_policy.php?id=<?php echo $policy['id'];?>" class="btn btn-sm btn-danger" style="margin-right: 5px;"><i class="bi bi-trash"></i></a>
