...
// Checkin What level user has permission to view this page
 ...
 $groups = find_all('client_information_core1');
 $users_id = current_user()['id'];
// $result = find_vendor_by_id('audit',$users_id);
 $is_show = 1;
 $all_vendors = find_all('client_information_core1');
?>
<?php
  if(isset($_POST['applicationform'])){
   ...
   if(empty($errors)){
       ...
       $body   = remove_junk($db->escape($_POST['body']));
        $query = "INSERT INTO client_information_core1 (";
        ...
        if($db->query($query)){
          ...
          redirect('clientinformation.php', false);
        } else {
...
<div class="row">
  ...
  <?php endif; ?>
		...
		<a href="filestoring.php"><button type="button" class="btn btn-primary">All</button></a> 
		<a href="#"><button type="button" class="btn btn-light">HR 1</button></a> 
		...
		<a href="employeedocuments.php"><button type="button" class="btn btn-light">HR 4</button></a>
		<a href="clientinformation.php"><button type="button" class="btn btn-light">CORE 1</button></a> 
		<a href="#"><button type="button" class="btn btn-light">CORE 2</button></a>
		<a href="#.php"><button type="button" class="btn btn-lights">LOGISTIC 1</button></a>
     ...
     <div class="panel-body">
	  <div class="card-header">
        <span class="badge rounded-pill bg-success"><i class="bi bi-table"></i> Client Documents</span>
      </div>
      <head>
        ...
        <body>
        <div class="tab">
            <!-- <button class="tablinks" onclick="Tab(event, 'ApplicationForm')">Fill-up </button>end row -->
            <button class="tablinks" onclick="Tab(event, 'ViewData')" id="defaultOpen">View Documents</button>
        </div>

        <div id="ApplicationForm" class="tabcontent">
            <form method="post" action="clientinformation.php" autocomplete="off" enctype="multipart/form-data"> 
                ...
                <div class="btn-group">
                  <?php if($a_vendor['status'] === '2'): ?>
                   ...
                   <?php endif; ?>
					...
					<button a href="edit_categorie.php?id=<?php echo (int)$complainant['id'];?>" class="btn btn-info">Archive</button>	
