...
<div class="row">
  ...
  <?php endif; ?>
		...
		<a href="admin.php"><button type="button" class="btn btn-primary">Home</button></a> 
		<a href="#"><button type="button" class="btn btn-light">Employee Document</button></a> 
		<a href="#.php"><button type="button" class="btn btn-light">Client info</button></a>
		<a href="Ledger.php"><button type="button" class="btn btn-lights">Ledger</button></a>
		<a href="#.php"><button type="button" class="btn btn-lights">Payroll Report</button></a>
