...
<div class="row">
  ...
  $query = mysqli_query($conn, "SELECT * FROM facility WHERE id = {$resignid}");
...
<div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        <span class="badge rounded-pill bg-success"><i class="bi bi-pencil"></i> Edit facility Information</span>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-lg-7">
            <div class="card-box">
              <form action="edit-facility.php" method="POST">
			  ...
			  <div class="form-group row">
                ...
                <div class="form-group row">
                  <label class="col-form-label col-md-4">Room</label>
                    <div class="col-md-8">
				  ...
				  <br>
                  <div class="form-group row">
                    <label class="col-form-label col-md-4">Name of Room</label>
                    <div class="col-md-8">
                      <input type="text" name="name_of_room" value="<?php echo $row['name_of_room']; ?>" class="form-control">
                    </div>
                  </div>
                  <br>
				  <div class="form-group row">
