<?php
  $page_title = 'List of Car loan';
  require_once('includes/load.php');
  // Checkin What level user has permission to view this page
   page_require_level(2);
   $all_car_loans = find_all('car_loans')
?>
...
<nav class="breadcrumbs">
  ...
  <?php endif; ?>
  <a href="#" class="breadcrumbs__item is-active">Car Loan</a>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="row" style="padding-left:1x;">
                                    ...
                                    <div class="input-group mb-1">
										<span class="input-group-text" id="basic-addon1">Car Loan Id:</span>
										<input type="text" class="form-control" placeholder="Car Loan id" name="get_carid" required>
										</div>   
										
										
                                       <button type="submit" name="search" style="margin-top:10px;" class="btn btn-primary">Search</button>
									   <a href="carloan.php">Refresh</a>
                            ...
                            <?php 
                                ...
                                if(isset($_POST['get_carid']) ){
                                    ...
                                    $query = "SELECT * FROM car_loans WHERE id= '$carid' ";
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table
            ...
            <?php foreach ($all_car_loans as $loan):?>
                <tr>
