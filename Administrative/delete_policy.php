...
<div class="row">
  ...
  <!-- End Notification div -->
        ...
        $query = mysqli_query($conn, "SELECT * FROM visitorpolicy WHERE id = {$promotedid}");
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-lg-12">
            <div class="card-box">
              <form action="delete-policy.php" method="POST">
                <input type="hidden" name="del_id" class="form-control" value="<?php echo $row['id'];?>">
                  <div class="form-group row mt-10">
                    ...
                    <div class="col-md-12">
                      ...
                      <a href="visitorpolicy.php" class="btn btn-secondary text-white" data-dismiss="modal">Back</a>
                    </div>
                  </div>
                </form>
              </div>
