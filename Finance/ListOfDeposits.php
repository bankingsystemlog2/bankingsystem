  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        <span class="badge rounded-pill bg-success" style="font-size:14px;"><i class="bi bi-table"></i> Deposits Table</span>
      </div>
      <div class="card-body">
        <div class="table-responsive">
          <table
            ...
            <tbody>
             ...
             <td>
               <a href="Collection_Details.php?id=<?php echo $row['Co_Code']. "&Tablename=". urlencode($Table)."&PageName=". urlencode('ListOfDeposits.php'); ?>" class="btn btn-success bg-gradient btn-viewReciept"><i class="bi bi-file-earmark-post-fill"></i> Details</a></td>
              </tr>
             <?php endif; ?>
            <?php endforeach; ?>
