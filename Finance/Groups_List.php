...
<nav class="breadcrumbs">
  ...
  <?php endif; ?>
  <a href="#checkout" class="breadcrumbs__item is-active">List of Groups</a>
</nav>
<!-- /Breadcrumb -->
  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        <span class="badge rounded-pill bg-success"><i class="bi bi-table"></i>List of Groups</span>
        <div class="text-end">
      			<a href="javascript:void(0)" id="create_new" class="btn btn-success bg-gradient"><span class="bi bi-plus-circle-fill"></span>  Add New</a>
        </div>
      </div>
      <div class="card-body">
               ...
               <td>
                ...
                <button class="btn btn-success bg-gradient dropdown-toggle btn-sm" type="button" id="dropdownMenuAccounts" data-bs-toggle="dropdown" aria-expanded="false">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuAccounts">
                    <li><a class="dropdown-item view_data" data-id ="<?= $acc['id'] ?>"  data-tbl="group_list"><span class="text-success bi bi-eye-fill"></span> View</a></li>
