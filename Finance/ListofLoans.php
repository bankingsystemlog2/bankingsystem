  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        <span class="badge rounded-pill bg-success" style="font-size:14px;"><i class="bi bi-table"></i> Loans Table</span>
      </div>
      <div class="card-body">
          ...
          <table
            ...
            <tbody>
             ...
             <?php foreach ($row as $row): ?>
                ...
                <td>
                  <a href="Collection_Details.php?id=<?php echo $row['Co_Code']. "&Tablename=". urlencode($Table)."&PageName=". urlencode('ListofLoans.php'); ?>" class="btn btn-success bg-gradient btn-viewReciept text-light"><i class="bi bi-file-earmark-post-fill"></i> Details</a></td>
                 </tr>
              <?php endif; ?>
            <?php endforeach; ?>
