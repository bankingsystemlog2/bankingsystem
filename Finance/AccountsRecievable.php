        ...
        <div class="table-responsive">
          <table
           ...
           <tbody>
            ...
            <td>
            <a href="Collection_Details.php?id=<?php echo $row['P_Code']. "&Tablename=". urlencode($Table)."&PageName=". urlencode('AccountsRecievable.php'); ?>" class="btn btn-info bg-gradient btn-viewReciept"><i class="bi bi-file-earmark-post-fill"></i> Details</a></td>
              </td>
             </tr>
           <?php endforeach; ?>
         </tbody>
