        ...
        <div class="table-responsive">
          <table
            ...
            <tbody>
              ...
              <td><a href="DisbursmentDetails.php?id=<?php echo (int)$row['Co_Code']. "&Tablename=". urlencode($Table)."&PageName=". urlencode('procurment.php');?>" class="btn btn-success bg-gradient btn-viewReciept"><i class="bi bi-file-earmark-medical-fill"></i> Details</a></td>
               </tr>
             <?php elseif ($row['Status']=='Approved'):?>
               <tr>
                 ...
                 <td><a href="DisbursmentDetails.php?id=<?php echo (int)$row['Co_Code']. "&Tablename=". urlencode($Table)."&PageName=". urlencode('procurment.php');?>" class="btn btn-success bg-gradient btn-viewReciept"><i class="bi bi-file-earmark-medical-fill"></i> Detail</a></td>
               </tr>
             <?php endif; ?>
             <?php endforeach; ?>
          </tbody>
