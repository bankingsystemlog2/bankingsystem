          ...
          <div class="col-lg-12">
            <div class="card-box">
              <form action="hr2-codes.php" method="POST">
                <input type="hidden" name="delPromId" class="form-control" value="<?php echo $row['p_id'];?>">
                  <div class="form-group row mt-10">
                    <label class="col-form-label col-md-4">Are You Sure You Want To Delete This Promotion?</label>
                    <div class="col-md-12">
                      <button type="submit" name="delNewOne" class="btn btn-danger text-white">Delete</button>
