  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        ...
        <div class="text-end">
          <a href="add-question.php?page=core_exams.php" class="btn btn-primary btn-xs-block">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table
           ...
           <tbody>
                    <?php
                    $att_list = "SELECT * FROM questionaires WHERE department = 'admin'";
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="delete-question.php?id=<?php echo $row['id']; ?>&page=core_exams.php" class="btn btn-sm btn-danger pull-right">Delete</a>
                        </td>
                    </tr>
                    <?php
                    }
