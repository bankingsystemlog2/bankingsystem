...
/*--------------------------------------------------------------*/
 ...
 /*--------------------------------------------------------------*/
  ...
  function find_all_learning_sched(){
      global $db;
      $results = array();
      $sql = "SELECT * FROM seminar_sched";
      $result = find_by_sql($sql);
      return $result;
  }
  ...
  function find_all_learning_sched_approval(){
      global $db;
      $results = array();
      $sql = "SELECT * FROM seminar_sched WHERE approval_status = 'pending'";
      $result = find_by_sql($sql);
      return $result;
  }
  /*--------------------------------------------------------------*/
