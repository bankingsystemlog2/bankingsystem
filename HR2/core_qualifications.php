  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
         <span class="badge rounded-pill bg-success"><i class="bi bi-table"></i> Core Job Qualifications</span>
        <div class="text-end">
          <a href="add-qualification.php?page=core_qualifications.php" class="btn btn-primary btn-xs-block">
          ...
          <table
           ...
           <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit-qualification.php?id=<?php echo $row['id']; ?>&page=core_qualifications.php" class="btn btn-sm btn-success pull-right">Edit</a>
                            <a href="delete-qualification.php?id=<?php echo $row['id']; ?>&page=core_qualifications.php" class="btn btn-sm btn-danger pull-right">Delete</a>
                        </td>
                    </tr>
                    <?php
                    }
