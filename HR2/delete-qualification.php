  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        <span class="badge rounded-pill bg-danger"><i class="bi bi-trash"></i> Delete Qualification</span>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-lg-12">
              ...
              <form action="hr2-codes.php" method="POST">
                ...
                <input type="hidden" name="page" value="<?php echo $_GET['page']?>">
                  <div class="form-group row mt-10">
                    ...
                    <div class="col-md-12">
                      <button type="submit" name="delquali" class="btn btn-danger text-white">Delete</button>
