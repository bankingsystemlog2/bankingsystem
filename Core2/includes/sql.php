...
function find_contract_request()
{
  global $db;
  $sql = "SELECT * from request_contract Where department = 'CORE1' ";
 ...
 function updateLastLogIn($user_id)
  ...
  /*End of Sub notifications -----------------------------------------------------------*/
          ...
          /*--------------------------------------------------------------*/
           ...
           /*--------------------------------------------------------------*/
           /* noel edited for client info
           /*--------------------------------------------------------------*/
           function client_info(){
             global $db;
             $sql = "SELECT * FROM mortgages" or die($mysqli->error);
           ...
           function a_request(){
             global $db;
             $sql = "SELECT * FROM `request_contract`" or die($mysqli->error);
             return find_by_sql($sql);
           }
           ...
           /*--------------------------------------------*/
            /* noel edited loan processing approval
            /* 
            /*--------------------------------------------------------------*/
           function loan_process(){
              global $db;
              $sql = "SELECT * FROM loan_processing_approval ";
             return find_by_sql($sql);
            }

            function  loan_payment(){
              global $db;
              $sql = "SELECT * FROM loan_payment_monitoring";
             return find_by_sql($sql);
            }
            ...
            function  loan_restructuring(){
              global $db;
              $sql = "SELECT * FROM loan_restructuring";
             return find_by_sql($sql);
           }

            function  approve(){
              global $db;
              $sql = "SELECT * FROM loan_processing_approval WHERE Status='Approved'";
             return find_by_sql($sql);
           }
